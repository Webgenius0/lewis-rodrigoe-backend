            ...
            <ul class="navbar-nav flex-column" id="sideNavbar">
                ...
                <li class="nav-item">
                    <a class="nav-link has-arrow" href="#!" data-bs-toggle="collapse" data-bs-target="#location"
                        ...
                        <svg viewBox="-4 0 32 32" width="20px" style="padding-right: 5px;" version="1.1"
                            ...
                            <g id="SVGRepo_iconCarrier">
                                ...
                                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"
                                    ...
                                    <g id="Icon-Set" sketch:type="MSLayerGroup"
                                        ...
                                        fill="{{ Route::is('v1.location.*') ? '#624bff' : '#a5acb6' }}">
                                        <path
                    ...
                    <div id="location" class="collapse {{ Route::is('location.*') ? 'show' : '' }} "
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link has-arrow  {{ Route::is('location.city.index') ? 'active' : '' }} "
                                    href="{{ route('location.city.index') }}">
                                    City
                                </a>
                            </li>
                        </ul>
